...
::: info 步骤\r
\r
去 \`alist\` 的 [\`开源仓库\`](https://github.com/alist-org/alist/releases){target="_blank"} 下载适用的软件版本 ，大多数人是它 👉  \`alist-windows-amd64.zip\`，**解压这个文件后** 会得到一个 \`.exe\` 文件，把它放在你喜欢的文件夹中，例如：D:/alist/alist.exe\r
\r
::: \r
### 2.2 启动项目\r
\r
