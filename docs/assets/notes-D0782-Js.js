import{cb as c,cc as u,cd as h}from"./index-Cdj59hPb.js";const v="",_=`## .gitignore 文件\r
\r
...
`,w="## 图片语法\r\n\r\n```markdown\r\n!img[desc](name)\r\n```\r\n\r\n## 卡片语法\r\n\r\n```markdown\r\n!card[type](key)\r\n```\r\n```markdown\r\n!card[note](name)\r\n```\r\n```markdown\r\n!card[post](name)\r\n```",j=`**备注信息**\r
\r
- 配置文章标签时，将最重要的放在前面，文章预览页只显示前三个`,k=`---\r
title: 'Boke使用指南'\r
cover: 'boke2'\r
...
\r
http://aniu.website/  \r
https://aniu.website/`,D=`## 无法备案的域名\r
\r
...
text: '建站笔记'\r
desc: '我的建站笔记'\r
---`,G="# C\\#",N="官网 [enter](https://visualstudio.microsoft.com/zh-hans/downloads/){target='_blank'}",L=`::: danger \r
\r
...
版本: 1.3.10\r
发布者: Microsoft\r
VS Marketplace 链接: https://marketplace.visualstudio.com/items?itemName=ms-dotnettools.csdevkit`,J=`## 简介\r
\r
...
\r
using  \r
namespace`,U=`- 区别字母的大小写\r
- 语句与表达式必须以分号结尾`,V="",X=`## 下载\r
\r
...
\r
\r
详见 -> [\`vitepress中使用element-plus\`](/zo-articles/24090101%20Vitepress中使用element-plus.md){target="_blank"}`,H=`\r
\r
`,Y=`## win10\r
\r
### 官方镜像\r
...
|docker volume prune|清除数据卷|docker volume prune|`,ir="",ar="## 删除容器\r\n```shell\r\ndocker rm\r\n```\r\n\r\n## 查看容器是否绑定数据卷\r\n\r\n```shell\r\ndocker inspect [容器名称]\r\n```",dr="",lr="",gr="",pr=`\r
\r
::: danger  <Badge type='danger'>重要警示</Badge>\r
本部分笔记内容，为简化代码量，笔记中涉及的代码不会考虑对 MAC 的兼容性  \r
:::\r
\r
https://www.electronjs.org/`,mr=`# 前置准备\r
\r
## 知识基础\r
\r
- node.js\r
...
\r
\`\`\``,Ir="",Ar=`::: danger <Badge type='warning'>特别注意</Badge>\r
\r
...
## 4. 攻略笔记\r
\r
- 开局的生日选择`,Wr=`## 1.2 美化教程\r
\r
- 打开 N 网 `,Hr="",Yr=`## 盖世小鸡启明星\r
\r
### 叠卷购买指南\r
### 使用指南（接受器）\r
\r
...
\r
![](/image/202410272311.png)`,Kr="",Zr="",$r="",rn=`## 用户设置\r
### 全局\r
\r
---\r
\r
...
:::`,en=`## 仓库的容量\r
\r
https://github.com/settings/repositories`,tn=`\r
...
### 2.2 使用组件库\r
\r
例如可以使用 Element-ui 的 icon 组件实现。`,vn=`---\r
aside: false\r
---\r
\r
\r
...
<br/>\r
\r
`,yn="<Badge type='danger'>该页面未完善</Badge>\r\n\r\n## 字面量\r\n\r\n> 其实专业的说法蛮抽象的\r\n\r\n> 功利的角度来看， `=` 后面的具体代码就是字面量\r\n\r\n```javascript\r\n// 120 就是字面量\r\nlet x = 120\r\n```\r\n\r\n## 输入\r\n\r\n```javascript\r\nprompt()\r\n```\r\n\r\n## 输出\r\n\r\n```javascript\r\nconsole.log();\r\n```\r\n\r\n```javascript\r\nalert()\r\n```\r\n\r\n```javascript\r\ndocument.write()\r\n```",bn=`\r
# 变量与常量\r
\r
## 声明变量与赋值\r
\r
...
\`\`\`javascript\r
const week = 7\r
\`\`\``,fn=`<Badge type='danger'>该页面未完善</Badge>\r
\r
\r
# 数据类型\r
\r
...
\r
- continue 退出本次循环\r
- break 退出循环`,kn=`- F12 - sources - 行号打断点 - 刷新浏览器\r
\r
\r
## throw\r
\r
...
\r
性能测试的结果可能因浏览器和硬件环境的不同而有所差异，但一般来说，indexOf() 和 search() 方法的性能最好，因为它们直接由Javascript引擎优化。Match() 和 Split() 方法由于涉及到正则表达式或数组操作，性能稍差。而 Includes() 方法虽然语法简洁，但在性能上可能不如其他方法。因此，在选择字符串查找方法时，应根据具体需求和性能要求来选择合适的方法。`,Tn=`substring() 方法；\r
substr() 方法；\r
slice() 方法；`,En=`- 数组是一个对象，也叫对象数组\r
\r
## 声明\r
\r
\`\`\`javascript\r
...
\r
\`\`\``,Mn=`5.实例方法join数组元素拼接为字符串，返回字符串（重点）\r
...
13.实例方法findIndex查找元素的索引l值`,Gn="",Nn="",Ln=`- 对象是一个数据类型\r
- 是无序的数据集合\r
\r
\`\`\`js\r
\r
...
\r
\`\`\``,Xn=`- 对象解构是将对象属性和方法快速批量赋值给一系列变量的简洁语法\r
\r
\`\`\`js\r
// 变量名称应和属性名称相同\r
...
- 只是提升当前作用域内的最前面 \r
\r
- 只提升声明，不提示赋值`,Zn=`- 没有命名的函数就是匿名函数\r
\r
- 没有名字的函数无法直接使用\r
\r
- 函数表达式\r
...
每个函数中都存在this\r
\r
this指向的是函数的调用者`,ne="会把所有函数的声明提升到作用域的最前面",ee=`## 基本语法\r
\r
- 没有动态参数\r
\r
...
- apply()\r
\r
- bind()`,oe="- DOM（Document Object Model - 文档对象模型）是用来呈现以及与任意 `HTML` 或 `XML`文档交互的 `API`\r\n- DOM 是浏览器提供的一套专门用来操作网页内容的功能 \r\n- DOM 树 就是 html 界面的元素的嵌套关系",ie=`- 获取DOM元素，也称为获取DOM对象\r
\r
...
let date = +new Date()\r
\r
\`\`\``,ve="",_e="",ye="window是顶级对象",be="",fe="",we="```js\r\n\r\nwindow.location\r\n\r\n```",je=`> 数据以字符串类型保存\r
\r
## 基本用法\r
\r
\`\`\`js\r
...
\r
大佬的博客：\r
https://lijing-2008.gitlab.io/coderli-vitepress/`,Oe=`## 安装\r
\r
- 安装脚手架\r
\r
::: code-group\r
...
## orm\r
\r
`,Fe=`::: danger <Badge type='warning'>温馨提示</Badge>\r
本部分内容是将，**网络请求** 的相关知识集合在一起，进行整理和归纳   \r
包括：\r
- axios \r
:::`,Ce="",De="",Ie="web服务器",Ae=`## 1. centOS\r
\r
\r
## 1.1 下载\r
\r
...
|切换盘符|\`C:\` 、 \`D:\`|\r
|进入目录（文件夹）|\`cd ./文件夹名\`|\r
|查看目录内容清单|\`dir\`|`,Je=`- 不能使用BOM和DOM的api\r
\r
- 顶级对象\r
\r
不再是 js 中的 window\r
...
\r
\r
\`nvm install [version]\` -> \`nvm on\``,Xe=`\r
...
\`\`\``,at="",dt=`## npm 无法安装 sqlite3 \r
\r
解决办法：开全局魔法\r
\r
## 中文乱码`,lt="\r\n\r\n\r\n|解释型语言|编译型语言|\r\n|---|---|\r\n|运行时，才被翻译运行|写完代码后，先编译，编译后运行|\r\n| `python` 、 `php` 、 `javasrcipt` | `C语言` 、 `java` 、 `go` |",gt=`\r
\r
## :one: 下载 VScode (VSC)\r
\r
- 代码编辑器，用来编写代码的\r
...
\r
![img](/image/202402141345.png)`,wt="```javascript\r\nconst useEffect(()=>{},[])\r\n```",jt=`## 安装\r
\r
::: code-group\r
\r
\`\`\`shell\r
...
> \r
\r
![img](/image/202402141811.png)`,zt=`# SCSS\r
\r
👇 **重要说明与提示**\r
\r
...
\`\`\`\r
\r
:::`,Lt="",Jt='## 数据库管理工具\r\n\r\nheidisql [`👉 enter`](https://www.heidisql.com/download.php?download=portable-64){target="_blank"}  ',Ut="",Vt=`\r
## 介绍\r
\r
...
\r
\`\`\``,Ht=`[] 001  \r
[] 002  `,Yt='官网\r\n[`👉 enter`](https://uniapp.dcloud.net.cn/){target="_blank"}',Kt=`## 1. 编辑器下载\r
\r
...
│  ○ Custom Theme\r
└\r
\`\`\``,ss="",os="",is=`::: danger <Badge type='danger'>注意</Badge>\r
\r
...
\r
\r
`,fs="- 虽说 `vitepress` 强调使用的是 `markdown` 语法  \r\n- 但是，但是不要忘记，**markdown**文件中是可以使用 **html** 语法的  \r\n- 当然，必要时，也可以用 **vue** 语法， ",ws=`## 重要性\r
\r
<br>\r
\r
...
\r
\`\`\``,Ns="https://www.bilibili.com/video/BV1YW4y1F7uJ/?spm_id_from=333.1007.tianma.1-1-1.click",Ls=`::: danger  <Badge type='danger'>易错警告</Badge>\r
\r
...
VS Marketplace 链接: https://marketplace.visualstudio.com/items?itemName=vscode-icons-team.vscode-icons`,no="",eo=`# cssrem\r
\r
\r
\r
## 插件信息\r
...
\r
:::\r
`,to=`# Markdown Preview Enhanced\r
\r
## 插件信息\r
::: info  <Badge type='info'>基本信息</Badge>\r
\r
...
版本: 12.7.0\r
发布者: VSCode Icons Team\r
VS Marketplace 链接: https://marketplace.visualstudio.com/items?itemName=vscode-icons-team.vscode-icons`,oo=`### VSCode markdown 文件中无法使用用户代码片段 snippet 问题\r
\r
#### 方法一：  \r
\r
...
\r
\`C:\\Users\\long\\AppData\\Roaming\\Code\\User\\snippets\``,ao="",lo=`---\r
aside: false\r
---\r
# Vue\r
\r
...
\r
\r
## 项目`,go=`::: danger  <Badge type='info'>警示</Badge>\r
请先安装node！！！\r
...
\`\`\`shell\r
pnpm i screenfull\r
\`\`\``,uo="单词的字母需要大写",ho="```js\r\nimport MyComponent from './App.vue'\r\n```",vo=`> 组件文件中 \`components/index.ts\`\r
\r
\`\`\`ts\r
...
\`\`\``,To="",Eo=`> 在src 下新建router文件夹，并创建router/index.js文件\r
\`\`\`javascript\r
// 导入\r
...
最大的建站的程序，\r
\r
`,Qo=Object.assign({"../notes/boke_docs_developer/01 项目下载.md":v,"../notes/boke_docs_developer/02 目录解读.md":_,"../notes/boke_docs_developer/config.md":y,"../notes/boke_docs_user/01 环境搭建.md":b,"../notes/boke_docs_user/02 配置信息.md":f,"../notes/boke_docs_user/03 MD语法扩展.md":w,"../notes/boke_docs_user/09 其他.md":j,"../notes/boke_docs_user/config.md":k,"../notes/build-site/00 简述.md":z,"../notes/build-site/01 基础知识/01 避坑指引.md":x,"../notes/build-site/01 基础知识/02 建站途径.md":B,"../notes/build-site/02 网站内容搭建/00 简述.md":q,"../notes/build-site/02 网站内容搭建/01 hexo.md":S,"../notes/build-site/02 网站内容搭建/02 vitepress.md":T,"../notes/build-site/02 网站内容搭建/03 其他.md":E,"../notes/build-site/03 网站部署/00 简述.md":P,"../notes/build-site/03 网站部署/01 服务器购买.md":O,"../notes/build-site/03 网站部署/02 后台搭建知识.md":F,"../notes/build-site/03 网站部署/03 nginx部署.md":C,"../notes/build-site/04 域名注册/00 简述.md":D,"../notes/build-site/04 域名注册/01 域名购买.md":I,"../notes/build-site/05 网站运维/01 服务器到期的处理.md":A,"../notes/build-site/config.md":M,"../notes/c-sharp/00 简述.md":G,"../notes/c-sharp/01 环境配置/01 使用VS2022.md":N,"../notes/c-sharp/01 环境配置/02 使用VScode.md":L,"../notes/c-sharp/02 基础知识/01 文件结构.md":J,"../notes/c-sharp/02 基础知识/02 基本语法.md":U,"../notes/cocos-creator/00 简述.md":V,"../notes/cocos-creator/01 环境配置/01 下载编辑器.md":X,"../notes/cocos-creator/01 环境配置/02 界面说明.md":Q,"../notes/component-library/00 简述.md":R,"../notes/component-library/01 Element-plus/01 导入.md":W,"../notes/computer/01 硬件知识/00 前言.md":H,"../notes/computer/02 系统相关/01 镜像下载.md":Y,"../notes/computer/02 系统相关/02 系统重装.md":K,"../notes/computer/03 扩展知识/02 虚拟机/02 虚拟机的创建/03 安装系统/01 win11演示.md":Z,"../notes/computer/03 扩展知识/02 虚拟机/03 常见使用/01 宿主机与虚拟机的交互.md":$,"../notes/computer/config.md":rr,"../notes/docker/00 简述.md":nr,"../notes/docker/01 环境配置/01 Linux安装docker.md":er,"../notes/docker/01 环境配置/02 windows安装docker.md":tr,"../notes/docker/02 基础知识/01 安装.md":sr,"../notes/docker/02 基础知识/02 基础指令.md":or,"../notes/docker/02 基础知识/03 镜像操作.md":ir,"../notes/docker/02 基础知识/04 容器操作.md":ar,"../notes/docker/02 基础知识/05 数据卷操作.md":dr,"../notes/docker/02 基础知识/06 自定义镜像.md":lr,"../notes/docker/02 基础知识/07 网络.md":gr,"../notes/electron/00 简述.md":pr,"../notes/electron/01 前置准备.md":mr,"../notes/electron/02 项目创建/01 安装与初始化.md":cr,"../notes/electron/03 调试工作/01 调试工具.md":ur,"../notes/electron/04 窗口/01 创建窗口.md":hr,"../notes/electron/05 主进程/01 app.md":vr,"../notes/electron/06 菜单/01 顶部菜单栏.md":_r,"../notes/electron/07 托盘/01 简述.md":yr,"../notes/express/00 简述.md":br,"../notes/express/01 导入与使用.md":fr,"../notes/express/04 数据库/01 sqlite3.md":wr,"../notes/express/04 数据库/02 mysql.md":jr,"../notes/express/04 数据库/03 sqlite3-ORM.md":kr,"../notes/express/08 示例项目/00 目录结构.md":zr,"../notes/express/08 示例项目/01 app.js.md":xr,"../notes/express/08 示例项目/02 db/01 blog.sqlite3文件.md":Br,"../notes/express/08 示例项目/02 db/02 DbUtils.js.md":qr,"../notes/express/08 示例项目/03 package-lock.json.md":Sr,"../notes/express/08 示例项目/04 package.json.md":Tr,"../notes/express/08 示例项目/06 routers/01 AdminRouter.js.md":Er,"../notes/express/08 示例项目/06 routers/02 BlogRouter.js.md":Pr,"../notes/express/08 示例项目/06 routers/03 CategoryRouter.js.md":Or,"../notes/express/08 示例项目/06 routers/04 TestRouter.js.md":Fr,"../notes/express/08 示例项目/06 routers/05 UploadRouter.js.md":Cr,"../notes/express/08 示例项目/07 utils/01 SnowFlake.js.md":Dr,"../notes/express/09 数据库使用.md":Ir,"../notes/game/00 简述.md":Ar,"../notes/game/01 游戏常识/01 steam基本知识.md":Mr,"../notes/game/01 游戏常识/01 平台相关.md":Gr,"../notes/game/01 游戏常识/02 MOD与修改器.md":Nr,"../notes/game/01 游戏常识/03 MOD与创意工坊.md":Lr,"../notes/game/01 游戏指南/01 戴森球.md":Jr,"../notes/game/01 游戏指南/02 中土世界：暗影摩多.md":Ur,"../notes/game/01 游戏指南/03 一起玩农场.md":Vr,"../notes/game/01 游戏指南/04 无人深空.md":Xr,"../notes/game/01 游戏指南/05 幻兽帕鲁.md":Qr,"../notes/game/01 游戏指南/06 波西亚时光.md":Rr,"../notes/game/01 游戏指南/07 星露谷.md":Wr,"../notes/game/01 游戏指南/08 生化危机.md":Hr,"../notes/game/02 手柄指南.md":Yr,"../notes/game/03 游戏合集/01 低配机可以的玩的游戏.md":Kr,"../notes/github/00 简述.md":Zr,"../notes/github/01 前置基础/01 Git下载与安装.md":$r,"../notes/github/01 前置基础/02 GIt指令.md":rn,"../notes/github/02 使用知识/01 账户设置.md":nn,"../notes/github/02 使用知识/02 仓库设置与操作.md":en,"../notes/github/02 使用知识/03 软件安装包区分.md":tn,"../notes/github/03 .gitignore设置.md":sn,"../notes/github/04 主页美化.md":on,"../notes/github/99 使用问题/01 software报错.md":an,"../notes/github/99 使用问题/02 action报错.md":dn,"../notes/html/00 简述.md":ln,"../notes/html/01 环境配置/01 浏览器选择.md":gn,"../notes/html/01 环境配置/02 编辑器选择.md":pn,"../notes/html/03 标签与功能/01 布局标签.md":mn,"../notes/html/03 标签与功能/02 图片.md":cn,"../notes/html/03 标签与功能/03 视频.md":un,"../notes/html/03 标签与功能/04 字体与字体图标.md":hn,"../notes/javascript/00 简述.md":vn,"../notes/javascript/01 基本知识/01 书写位置、注释与结束符.md":_n,"../notes/javascript/01 基本知识/03 基本语法.md":yn,"../notes/javascript/01 基本知识/04 变量与常量.md":bn,"../notes/javascript/01 基本知识/05 数据类型.md":fn,"../notes/javascript/01 基本知识/06 运算符号.md":wn,"../notes/javascript/01 基本知识/07 表达式与语句.md":jn,"../notes/javascript/01 基本知识/08 调试与异常处理.md":kn,"../notes/javascript/01 基本知识/09 JS的执行机制.md":zn,"../notes/javascript/01 基本知识/10 类型转换[进阶].md":xn,"../notes/javascript/01 基本知识/12 防抖.md":Bn,"../notes/javascript/02 字符串/01 方法.md":qn,"../notes/javascript/02 字符串/01 查询字符串.md":Sn,"../notes/javascript/02 字符串/02 截取字符串.md":Tn,"../notes/javascript/03 数组操作/01 数组基本操作.md":En,"../notes/javascript/03 数组操作/02 解构赋值.md":Pn,"../notes/javascript/03 数组操作/05 数组去重.md":On,"../notes/javascript/03 数组操作/06 map.md":Fn,"../notes/javascript/03 数组操作/07 join.md":Cn,"../notes/javascript/03 数组操作/09 forEach.md":Dn,"../notes/javascript/03 数组操作/10 filter.md":In,"../notes/javascript/03 数组操作/11 reduce.md":An,"../notes/javascript/03 数组操作/12 数组的其他方法.md":Mn,"../notes/javascript/03 数组操作/13 合并数组.md":Gn,"../notes/javascript/03 数组操作/14 数组去重.md":Nn,"../notes/javascript/04 对象/01 对象.md":Ln,"../notes/javascript/04 对象/02 增删改查.md":Jn,"../notes/javascript/04 对象/03 遍历对象.md":Un,"../notes/javascript/04 对象/04 math对象.md":Vn,"../notes/javascript/04 对象/05 对象解构赋值.md":Xn,"../notes/javascript/04 对象/06 内置的函数.md":Qn,"../notes/javascript/04 对象/07 深浅拷贝.md":Rn,"../notes/javascript/05 函数/01 声明.md":Wn,"../notes/javascript/05 函数/02 参数.md":Hn,"../notes/javascript/05 函数/03 返回值.md":Yn,"../notes/javascript/05 函数/04 作用域.md":Kn,"../notes/javascript/05 函数/05 匿名函数.md":Zn,"../notes/javascript/05 函数/06 回调函数.md":$n,"../notes/javascript/05 函数/07 环境对象.md":re,"../notes/javascript/05 函数/08 函数提升.md":ne,"../notes/javascript/05 函数/09 箭头函数.md":ee,"../notes/javascript/05 函数/10 构造函数.md":te,"../notes/javascript/05 函数/11 this.md":se,"../notes/javascript/06 DOM/01 简述.md":oe,"../notes/javascript/06 DOM/02 获取DOM元素.md":ie,"../notes/javascript/06 DOM/03 修改DOM元素.md":ae,"../notes/javascript/06 DOM/04 定时器.md":de,"../notes/javascript/06 DOM/05 标签的自定义属性.md":le,"../notes/javascript/06 DOM/06 事件监听（绑定).md":ge,"../notes/javascript/06 DOM/07 事件流.md":pe,"../notes/javascript/06 DOM/08 事件委托.md":me,"../notes/javascript/06 DOM/09 阻止默认行为.md":ce,"../notes/javascript/06 DOM/10 页面加载事件.md":ue,"../notes/javascript/06 DOM/11 日期对象.md":he,"../notes/javascript/06 DOM/12 节点操作.md":ve,"../notes/javascript/06 DOM/13 触屏事件.md":_e,"../notes/javascript/07 BOM/01 window对象.md":ye,"../notes/javascript/07 BOM/02 定时函数.md":be,"../notes/javascript/07 BOM/03 事件循环.md":fe,"../notes/javascript/07 BOM/04 location.md":we,"../notes/javascript/07 BOM/05 localStorage.md":je,"../notes/javascript/08 正则表达式/01 定义正则表达式.md":ke,"../notes/javascript/08 正则表达式/02 元字符.md":ze,"../notes/javascript/80 事件/01 点击事件.md":xe,"../notes/javascript/80 事件/02 鼠标事件.md":Be,"../notes/javascript/85 JS库/01 UUID.md":qe,"../notes/javascript/85 JS库/02 axios.md":Se,"../notes/javascript/config.md":Te,"../notes/mysql/00 简述.md":Ee,"../notes/nestjs/00 简述.md":Pe,"../notes/nestjs/02 基本/01 初始化项目.md":Oe,"../notes/network-request/00 简述.md":Fe,"../notes/network-request/01 axios/00 简述.md":Ce,"../notes/network-request/02 mo/01 mo.md":De,"../notes/nginx/00 简述.md":Ie,"../notes/nginx/01 下载与安装.md":Ae,"../notes/nginx/02 命令与配置.md":Me,"../notes/nodejs/00 简述.md":Ge,"../notes/nodejs/01 基础知识/00 下载与安装.md":Ne,"../notes/nodejs/01 基础知识/01 命令行基础.md":Le,"../notes/nodejs/01 基础知识/02 基本规则.md":Je,"../notes/nodejs/01 基础知识/03 buffer.md":Ue,"../notes/nodejs/01 基础知识/04 版本管理.md":Ve,"../notes/nodejs/02 包管理工具/01 基本操作.md":Xe,"../notes/nodejs/02 包管理工具/02 发布与管理.md":Qe,"../notes/nodejs/03 模块知识/00 模块使用与导入.md":Re,"../notes/nodejs/03 模块知识/01 文件模块-file/01 文件写入.md":We,"../notes/nodejs/03 模块知识/01 文件模块-file/03 文件读取.md":He,"../notes/nodejs/03 模块知识/01 文件模块-file/04 文件重命名与移动.md":Ye,"../notes/nodejs/03 模块知识/01 文件模块-file/05 文件删除.md":Ke,"../notes/nodejs/03 模块知识/01 文件模块-file/06 文件夹操作.md":Ze,"../notes/nodejs/03 模块知识/01 文件模块-file/07 文件信息查询.md":$e,"../notes/nodejs/03 模块知识/02 路径模块-path/01 path.md":rt,"../notes/nodejs/03 模块知识/03 网络模块-http/01 HTTP协议.md":nt,"../notes/nodejs/03 模块知识/03 网络模块-http/02 http模块.md":et,"../notes/nodejs/03 模块知识/03 网络模块-http/03 http练习.md":tt,"../notes/nodejs/03 模块知识/04 模块化开发/01 模块化.md":st,"../notes/nodejs/03 模块知识/05 模板引擎/ejs.md":ot,"../notes/nodejs/05 小技巧与功能实现/01 node注册成win服务.md":it,"../notes/nodejs/09 es语法差异/01 差异.md":at,"../notes/nodejs/99 报错合集.md":dt,"../notes/python/00 简述.md":lt,"../notes/python/01 环境配置/01 编辑器环境.md":gt,"../notes/python/01 环境配置/02 python环境.md":pt,"../notes/python/02 基础知识/01 注释.md":mt,"../notes/python/02 基础知识/02 字面量与常量.md":ct,"../notes/python/02 基础知识/03 变量.md":ut,"../notes/react/00 简述.md":ht,"../notes/react/01 前置准备/01 知识储备.md":vt,"../notes/react/01 前置准备/02 开发环境.md":_t,"../notes/react/04 数据绑定/02 input.md":yt,"../notes/react/04 数据绑定/03 dom绑定.md":bt,"../notes/react/05 组件通信/01 父子通信.md":ft,"../notes/react/06 useEffect/01 01.md":wt,"../notes/react/08 redux/01 基本使用.md":jt,"../notes/react/08 redux/02 React中使用.md":kt,"../notes/scss/00 简述.md":zt,"../notes/scss/01 基础知识/00 定义变量.md":xt,"../notes/scss/01 基础知识/01 文件引用.md":Bt,"../notes/scss/01 基础知识/03 全局使用.md":qt,"../notes/scss/02 字体与文本处理/01 改变字体.md":St,"../notes/scss/02 字体与文本处理/02 引用字体.md":Tt,"../notes/scss/02 字体与文本处理/03 字体资源.md":Et,"../notes/scss/02 字体与文本处理/04 渐变字体.md":Pt,"../notes/scss/02 字体与文本处理/05 下划线.md":Ot,"../notes/scss/04 界面切换/01 简述.md":Ft,"../notes/scss/09 常见应用/01 滚动条美化.md":Ct,"../notes/scss/09 常见应用/02 样式清楚.md":Dt,"../notes/scss/09 常见应用/03 移动端适配.md":It,"../notes/scss/09 常见应用/04 界面阴影.md":At,"../notes/scss/09 常见应用/05 网格背景.md":Mt,"../notes/scss/09 常见应用/06 彩虹背景.md":Gt,"../notes/scss/09 常见应用/07 毛玻璃效果.md":Nt,"../notes/sqlite/00 简述.md":Lt,"../notes/sqlite/01 下载与使用.md":Jt,"../notes/teleplay/02 影视评价.md":Ut,"../notes/typescript/00 简述.md":Vt,"../notes/typescript/01 基础与语法/01 安装与使用.md":Xt,"../notes/typescript/01 基础与语法/02 初始化项目.md":Qt,"../notes/typescript/01 基础与语法/03 类型声明.md":Rt,"../notes/typescript/02 类型/01 原始类型.md":Wt,"../notes/typescript/02 类型/02 元组.md":Ht,"../notes/uniapp/00 简述.md":Yt,"../notes/uniapp/01 基本配置/01 编辑器环境.md":Kt,"../notes/uniapp/01 基本配置/02 项目创建.md":Zt,"../notes/uniapp/02 模块设计/03 底部导航.md":$t,"../notes/uniapp/02 模块设计/04 启动界面.md":rs,"../notes/vitepress/00 简述.md":ns,"../notes/vitepress/01 项目创建/00 环境配置.md":es,"../notes/vitepress/01 项目创建/01 安装与初始化.md":ts,"../notes/vitepress/01 项目创建/02 项目目录解读.md":ss,"../notes/vitepress/01 项目创建/03 本地运行与调试.md":os,"../notes/vitepress/01 项目创建/04 个人特色配置.md":is,"../notes/vitepress/02 站点配置/01 站点元数据.md":as,"../notes/vitepress/03 网站编辑/00 简述.md":ds,"../notes/vitepress/03 网站编辑/01 标题：SiteTitle.md":ls,"../notes/vitepress/03 网站编辑/02 标志：Logo.md":gs,"../notes/vitepress/03 网站编辑/03 导航菜单：Nav.md":ps,"../notes/vitepress/03 网站编辑/04 侧边栏：sidebar.md":ms,"../notes/vitepress/03 网站编辑/05 页面大纲：outline.md":cs,"../notes/vitepress/03 网站编辑/06 大纲容器：aside.md":us,"../notes/vitepress/03 网站编辑/07 页脚：footer.md":hs,"../notes/vitepress/03 网站编辑/08 搜索：search.md":vs,"../notes/vitepress/03 网站编辑/09 徽章：badge.md":_s,"../notes/vitepress/03 网站编辑/10 社交链接.md":ys,"../notes/vitepress/03 网站编辑/99 frontmatter.md":bs,"../notes/vitepress/04 文档编辑/00 简述.md":fs,"../notes/vitepress/04 文档编辑/01 文件路径.md":ws,"../notes/vitepress/04 文档编辑/02 标题.md":js,"../notes/vitepress/04 文档编辑/03 文字强调.md":ks,"../notes/vitepress/04 文档编辑/04 下划线.md":zs,"../notes/vitepress/04 文档编辑/05 字体美化.md":xs,"../notes/vitepress/04 文档编辑/06 超链接.md":Bs,"../notes/vitepress/04 文档编辑/07 列表.md":qs,"../notes/vitepress/04 文档编辑/08 表格.md":Ss,"../notes/vitepress/04 文档编辑/09 图片.md":Ts,"../notes/vitepress/04 文档编辑/10 emoji 表情.md":Es,"../notes/vitepress/04 文档编辑/11 自定义容器.md":Ps,"../notes/vitepress/04 文档编辑/12 代码块.md":Os,"../notes/vitepress/04 文档编辑/13 代码组.md":Fs,"../notes/vitepress/04 文档编辑/14 脚注.md":Cs,"../notes/vitepress/04 文档编辑/15 思维导图.md":Ds,"../notes/vitepress/04 文档编辑/16 分割线.md":Is,"../notes/vitepress/04 文档编辑/45 嵌入文档.md":As,"../notes/vitepress/04 文档编辑/99 视频.md":Ms,"../notes/vitepress/05 使用vue/01 组件的全局注册.md":Gs,"../notes/vitepress/06 项目部署/01 Github部署/01 前置步骤.md":Ns,"../notes/vitepress/06 项目部署/01 Github部署/02 构建配置.md":Ls,"../notes/vitepress/06 项目部署/01 Github部署/03 自动化部署.md":Js,"../notes/vitepress/06 项目部署/01 Github部署/04 常规部署.md":Us,"../notes/vitepress/06 项目部署/02 服务器部署/01 node后台.md":Vs,"../notes/vitepress/07 插件生态.md":Xs,"../notes/vitepress/10 问题与报错.md":Qs,"../notes/vitepress/config.md":Rs,"../notes/vscode/00 简述.md":Ws,"../notes/vscode/01 下载与安装/01 下载.md":Hs,"../notes/vscode/01 下载与安装/02 汉化.md":Ys,"../notes/vscode/02 基本使用/01 常用设置.md":Ks,"../notes/vscode/02 基本使用/02 快捷键.md":Zs,"../notes/vscode/02 基本使用/03 用户代码片段.md":$s,"../notes/vscode/03 插件/00 插件安装演示.md":ro,"../notes/vscode/03 插件/01 通用型插件/01 ProjectManager.md":no,"../notes/vscode/03 插件/01 通用型插件/02 cssrem.md":eo,"../notes/vscode/03 插件/02 markdown相关/01 MarkdownPreviewEnhanced.md":to,"../notes/vscode/03 插件/99 自用插件清单.md":so,"../notes/vscode/04 相关问题/00 问题.md":oo,"../notes/vscode/05 代码片段/00 创建.md":io,"../notes/vscode/05 代码片段/01 markdown代码提示.md":ao,"../notes/vue/00 简述.md":lo,"../notes/vue/01 创建项目/01 vite构建.md":go,"../notes/vue/01 创建项目/02 目录解读.md":po,"../notes/vue/01 创建项目/03 原生html中使用.md":mo,"../notes/vue/01 创建项目/04 可选内容.md":co,"../notes/vue/04 组件基础/01 命名规范.md":uo,"../notes/vue/04 组件基础/01 导入组件.md":ho,"../notes/vue/04 组件基础/03 组件的全局注册.md":vo,"../notes/vue/05 响应式数据/01 ref、reactive.md":_o,"../notes/vue/05 响应式数据/02 自定义ref.md":yo,"../notes/vue/05 响应式数据/04 toRef.md":bo,"../notes/vue/05 响应式数据/05 双向绑定.md":fo,"../notes/vue/07 侦听器/01 watch.md":wo,"../notes/vue/07 侦听器/02 watchEffect.md":jo,"../notes/vue/09 生命周期/01 简述.md":ko,"../notes/vue/10 组件通信/01 简述.md":zo,"../notes/vue/10 组件通信/02 父子通信.md":xo,"../notes/vue/10 组件通信/03 祖孙通信.md":Bo,"../notes/vue/10 组件通信/04 兄弟通信.md":qo,"../notes/vue/10 组件通信/05 全局总线.md":So,"../notes/vue/80 路由/01 简述.md":To,"../notes/vue/80 路由/02 创建路由.md":Eo,"../notes/vue/80 路由/03 router-view.md":Po,"../notes/vue/80 路由/04 路由模式.md":Oo,"../notes/vue/80 路由/05 router-Link.md":Fo,"../notes/vue/80 路由/06 嵌套路由.md":Co,"../notes/vue/80 路由/07 编程式路由跳转.md":Do,"../notes/vue/80 路由/08 重定向.md":Io,"../notes/vue/90 pinia/01 创建.md":Ao,"../notes/vue/90 pinia/02 数据存储.md":Mo,"../notes/vue/91 UI组件库/01 element_UI.md":Go,"../notes/vue/97 vue2遗留问题/01 vue2与vue3不同点.md":No,"../notes/vue/98 项目练习/01 mo_browser.md":Lo,"../notes/vue/99 报错合集/01 部署问题.md":Jo,"../notes/vue/99 报错合集/04 router.md":Uo,"../notes/vue/vue.md":Vo,"../notes/wordpress/00 简述.md":Xo}),Ro={cover:"momo",desc:"暂无描述"};function Wo(){const n={};return Object.entries(Qo).forEach(([s,i])=>{const o=s.replace(/^.*notes\//,"").split("/"),r=o[0],e=o.slice(1).join("/"),{attributes:t,body:a}=c(i),{render:p}=u(),{html:d}=p(a);if(n[r]||(n[r]={id:r,path:"/notes/"+r,categories:[r],meta:{...Ro},files:[]}),e.toLowerCase()==="config.md")n[r].meta={...n[r].meta,...t},n[r].content=a,n[r].html=d;else{const m=e.replace(/\.md$/,""),l=h(e);n[r].files.push({id:l,meta:{...t,title:t.title||l},content:a,html:d,path:`/notes/${r}/${m}`,subPath:e.replace(/\.md$/,"")})}}),Object.values(n)}function Yo(n){return Wo().flatMap(s=>s.files).find(s=>s.path===n)}function Ko(n){const i=new DOMParser().parseFromString(n,"text/html");return Array.from(i.querySelectorAll("h2, h3, h4, h5, h6")).map(o=>{const r=Number(o.tagName.substring(1)),e=o.textContent?.trim()??"";let t=o.id?.trim()??"";return t||(t=e.toLowerCase().replace(/\s+/g,"-").replace(/[^\w\-]/g,"").replace(/\-+/g,"-").replace(/^\-+|\-+$/g,"")),{level:r,title:e,slug:t}})}export{Yo as a,Ko as b,Wo as g};
