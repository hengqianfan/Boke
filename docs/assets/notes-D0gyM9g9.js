import{cc as c,cd as u,ce as h}from"./index-Do_QJ2gL.js";const v=`## 0. 开发待解决问题\r
\r
- 完善自定义语法 cards \r
\r
- 优化 搜索框 的样式与逻辑\r
\r
- 首页点击下一页后，页面回到顶部`,_=`## 7. 遇到的问题\r
\r
- markdownIt 默认将代码块加上 \`<pre><code>\` 将自定义代码块与前后文产生较大距离\r
\r
`,b=`## .gitignore 文件\r
\r
> 用于忽略某些不需要 git 管理版本的文件\r
\r
## .vscode\r
\r
> 关于 VSCode 的配置\r
...
title: 'Boke开发者指南'\r
cover: 'boke'\r
desc: '这是面对具有一定vue项目经验的开发者提供的指南，方便开发者二次开发Boke，或者'\r
pin: 5\r
---`,w=`<!-- ## 本项目基于 -->\r
\r
## 1. 编辑器下载\r
...
### 3.1 title 标题\r
\r
- 可以为空，在未填写时，默认读取文件名为文章标题`,x=`**备注信息**\r
\r
- 配置文章标签时，将最重要的放在前面，文章预览页只显示前三个`,B=`---\r
title: 'Boke使用指南'\r
cover: 'boke2'\r
...
\r
http://aniu.website/  \r
https://aniu.website/`,M=`## 无法备案的域名\r
\r
...
text: '建站笔记'\r
desc: '我的建站笔记'\r
---`,J="# C\\#",U="官网 [enter](https://visualstudio.microsoft.com/zh-hans/downloads/){target='_blank'}",V=`::: danger \r
\r
...
版本: 1.3.10\r
发布者: Microsoft\r
VS Marketplace 链接: https://marketplace.visualstudio.com/items?itemName=ms-dotnettools.csdevkit`,X=`## 简介\r
\r
...
\r
using  \r
namespace`,Q=`- 区别字母的大小写\r
- 语句与表达式必须以分号结尾`,R="",W=`## 下载\r
\r
...
\r
\r
详见 -> [\`vitepress中使用element-plus\`](/zo-articles/24090101%20Vitepress中使用element-plus.md){target="_blank"}`,Z=`\r
\r
`,$=`## win10\r
\r
### 官方镜像\r
...
|docker volume prune|清除数据卷|docker volume prune|`,lr="",gr="## 删除容器\r\n```shell\r\ndocker rm\r\n```\r\n\r\n## 查看容器是否绑定数据卷\r\n\r\n```shell\r\ndocker inspect [容器名称]\r\n```",pr="",mr="",cr="",ur=`\r
\r
::: danger  <Badge type='danger'>重要警示</Badge>\r
本部分笔记内容，为简化代码量，笔记中涉及的代码不会考虑对 MAC 的兼容性  \r
:::\r
\r
https://www.electronjs.org/`,hr=`# 前置准备\r
\r
## 知识基础\r
\r
- node.js\r
...
\r
\`\`\``,Gr="",Nr=`::: danger <Badge type='warning'>特别注意</Badge>\r
\r
...
## 4. 攻略笔记\r
\r
- 开局的生日选择`,Kr=`## 1.2 美化教程\r
\r
- 打开 N 网 `,Zr="",$r=`## 盖世小鸡启明星\r
\r
### 叠卷购买指南\r
### 使用指南（接受器）\r
\r
...
\r
![](/image/202410272311.png)`,rn="",nn="",en="",tn=`## 用户设置\r
### 全局\r
\r
---\r
\r
...
:::`,on=`## 仓库的容量\r
\r
https://github.com/settings/repositories`,an=`\r
...
### 2.2 使用组件库\r
\r
例如可以使用 Element-ui 的 icon 组件实现。`,yn=`---\r
aside: false\r
---\r
\r
\r
...
<br/>\r
\r
`,wn="<Badge type='danger'>该页面未完善</Badge>\r\n\r\n## 字面量\r\n\r\n> 其实专业的说法蛮抽象的\r\n\r\n> 功利的角度来看， `=` 后面的具体代码就是字面量\r\n\r\n```javascript\r\n// 120 就是字面量\r\nlet x = 120\r\n```\r\n\r\n## 输入\r\n\r\n```javascript\r\nprompt()\r\n```\r\n\r\n## 输出\r\n\r\n```javascript\r\nconsole.log();\r\n```\r\n\r\n```javascript\r\nalert()\r\n```\r\n\r\n```javascript\r\ndocument.write()\r\n```",jn=`\r
# 变量与常量\r
\r
## 声明变量与赋值\r
\r
...
\`\`\`javascript\r
const week = 7\r
\`\`\``,kn=`<Badge type='danger'>该页面未完善</Badge>\r
\r
\r
# 数据类型\r
\r
...
\r
- continue 退出本次循环\r
- break 退出循环`,Bn=`- F12 - sources - 行号打断点 - 刷新浏览器\r
\r
\r
## throw\r
\r
...
\r
性能测试的结果可能因浏览器和硬件环境的不同而有所差异，但一般来说，indexOf() 和 search() 方法的性能最好，因为它们直接由Javascript引擎优化。Match() 和 Split() 方法由于涉及到正则表达式或数组操作，性能稍差。而 Includes() 方法虽然语法简洁，但在性能上可能不如其他方法。因此，在选择字符串查找方法时，应根据具体需求和性能要求来选择合适的方法。`,On=`substring() 方法；\r
substr() 方法；\r
slice() 方法；`,Cn=`- 数组是一个对象，也叫对象数组\r
\r
## 声明\r
\r
\`\`\`javascript\r
...
\r
\`\`\``,Ln=`5.实例方法join数组元素拼接为字符串，返回字符串（重点）\r
...
13.实例方法findIndex查找元素的索引l值`,Jn="",Un="",Vn=`- 对象是一个数据类型\r
- 是无序的数据集合\r
\r
\`\`\`js\r
\r
...
\r
\`\`\``,Wn=`- 对象解构是将对象属性和方法快速批量赋值给一系列变量的简洁语法\r
\r
\`\`\`js\r
// 变量名称应和属性名称相同\r
...
- 只是提升当前作用域内的最前面 \r
\r
- 只提升声明，不提示赋值`,ne=`- 没有命名的函数就是匿名函数\r
\r
- 没有名字的函数无法直接使用\r
\r
- 函数表达式\r
...
每个函数中都存在this\r
\r
this指向的是函数的调用者`,se="会把所有函数的声明提升到作用域的最前面",oe=`## 基本语法\r
\r
- 没有动态参数\r
\r
...
- apply()\r
\r
- bind()`,de="- DOM（Document Object Model - 文档对象模型）是用来呈现以及与任意 `HTML` 或 `XML`文档交互的 `API`\r\n- DOM 是浏览器提供的一套专门用来操作网页内容的功能 \r\n- DOM 树 就是 html 界面的元素的嵌套关系",le=`- 获取DOM元素，也称为获取DOM对象\r
\r
...
let date = +new Date()\r
\r
\`\`\``,ye="",fe="",we="window是顶级对象",je="",ke="",ze="```js\r\n\r\nwindow.location\r\n\r\n```",xe=`> 数据以字符串类型保存\r
\r
## 基本用法\r
\r
\`\`\`js\r
...
\r
大佬的博客：\r
https://lijing-2008.gitlab.io/coderli-vitepress/`,Fe=`## 安装\r
\r
- 安装脚手架\r
\r
::: code-group\r
...
## orm\r
\r
`,Ie=`::: danger <Badge type='warning'>温馨提示</Badge>\r
本部分内容是将，**网络请求** 的相关知识集合在一起，进行整理和归纳   \r
包括：\r
- axios \r
:::`,Ae="",Me="",Ge="web服务器",Ne=`## 1. centOS\r
\r
\r
## 1.1 下载\r
\r
...
# 📦 npm 常用命令速查手册\r
\r
> 适用于日常前端开发、Node.js 项目管理、CI/CD 环境等。  \r
> 版本：2025 年版\r
\r
---\r
\r
...
\r
\`\`\`bash\r
npm init             # 交互式创建 package.json\r
npm init -y          # 使用默认配置快速创建\r
npm install          # 安装 package.json 中的所有依赖\r
\`\`\`\r
\r
---\r
\r
...
\r
\`\`\`bash\r
npm install <包名>           # 安装到 dependencies\r
npm install <包名> -D        # 安装到 devDependencies\r
npm install <包名>@<版本>    # 安装指定版本\r
npm install <包名> -g        # 全局安装\r
npm ci                       # 按 package-lock.json 精确安装（常用于 CI）\r
\`\`\`\r
\r
📌 **常用参数：**\r
- \`-E\`：锁定精确版本  \r
- \`--force\`：忽略冲突强制安装  \r
- \`--legacy-peer-deps\`：忽略 peer 依赖冲突  \r
\r
---\r
\r
## 🧹 三、卸载依赖\r
\r
\`\`\`bash\r
npm uninstall <包名>        # 删除依赖\r
npm uninstall <包名> -D     # 删除开发依赖\r
npm uninstall -g <包名>     # 卸载全局包\r
\`\`\`\r
\r
---\r
\r
...
\r
\`\`\`bash\r
npm run <脚本名>    # 运行 package.json 中定义的脚本\r
npm start           # 运行 start 脚本（npm run start 的简写）\r
npm test            # 运行 test 脚本（npm run test 的简写）\r
npm run build       # 通常用于打包构建\r
\`\`\`\r
\r
📜 **示例 package.json：**\r
\`\`\`json\r
...
\`\`\`bash\r
npm update               # 更新所有依赖\r
npm update <包名>        # 更新指定依赖\r
npm outdated             # 查看可更新的依赖\r
npm install <包名>@latest # 更新到最新版\r
\`\`\`\r
\r
---\r
\r
...
\r
\`\`\`bash\r
npm list                   # 查看当前项目依赖树\r
npm list -g --depth=0      # 查看全局包\r
npm info <包名>            # 查看包的详细信息\r
npm view <包名> versions   # 查看包的所有版本\r
npm root                   # 查看依赖安装路径\r
npm root -g                # 查看全局安装路径\r
\`\`\`\r
\r
---\r
\r
...
npm config set registry https://registry.npmmirror.com   # 切换淘宝镜像\r
npm config set registry https://registry.npmjs.org       # 切回官方源\r
\`\`\`\r
\r
🔧 **推荐使用 \`nrm\` 工具快速切换：**\r
\`\`\`bash\r
...
\r
\`\`\`bash\r
npm login         # 登录 npm 账号\r
npm whoami        # 查看当前登录用户\r
npm logout        # 登出账号\r
\`\`\`\r
\r
---\r
...
\`\`\`bash\r
npm publish                        # 发布包\r
npm publish --access public         # 发布带 scope 的公共包\r
npm unpublish <包名>@<版本>         # 撤销发布（仅限 24 小时内）\r
\`\`\`\r
\r
📦 **示例：**\r
\`\`\`bash\r
npm publish --access public\r
\`\`\`\r
> 若包名为 \`@yourname/xxx\`，必须加上 \`--access public\`\r
\r
---\r
\r
## 🧾 十、配置与缓存\r
\r
\`\`\`bash\r
npm config list          # 查看当前配置\r
npm config edit          # 打开配置文件\r
npm cache verify         # 验证缓存\r
npm cache clean --force  # 清理缓存（解决安装异常常用）\r
\`\`\`\r
\r
---\r
\r
## ⚙️ 十一、Node 版本管理（配合使用）\r
\r
> 推荐使用 [nvm](https://github.com/nvm-sh/nvm)\r
\r
\`\`\`bash\r
nvm install <版本号>   # 安装指定 Node 版本\r
nvm use <版本号>       # 切换 Node 版本\r
nvm list               # 查看已安装的 Node 版本\r
\`\`\`\r
\r
---\r
\r
...
|------|------|\r
| 查看 npm 版本 | \`npm -v\` |\r
| 更新 npm 自身 | \`npm install -g npm\` |\r
| 安装全局包（如 Vite） | \`npm install -g vite\` |\r
| 创建锁定依赖 | \`npm shrinkwrap\` |\r
| 查看当前项目体积 | \`npm ls --prod --depth=0\` |\r
\r
---\r
\r
## 📚 附：推荐 npm 工具包\r
...
|------|------|\r
| \`nrm\` | 快速切换 npm 镜像 |\r
| \`npm-check-updates (ncu)\` | 批量更新依赖版本 |\r
| \`cross-env\` | 跨平台设置环境变量 |\r
| \`rimraf\` | 跨平台删除文件夹 |\r
| \`serve\` | 本地快速启动静态服务器 |\r
\r
---\r
\r
✅ **建议收藏**  \r
> 这份手册可以直接保存为 \`npm-cheatsheet.md\`，  \r
> 也可以放入你的项目 \`docs/\` 目录中，方便团队查阅。\r
`,Xe=`- 不能使用BOM和DOM的api\r
\r
- 顶级对象\r
\r
不再是 js 中的 window\r
...
\r
\r
\`nvm install [version]\` -> \`nvm on\``,We=`\r
...
\`\`\``,gt="",pt=`## npm 无法安装 sqlite3 \r
\r
解决办法：开全局魔法\r
\r
## 中文乱码`,mt="\r\n\r\n\r\n|解释型语言|编译型语言|\r\n|---|---|\r\n|运行时，才被翻译运行|写完代码后，先编译，编译后运行|\r\n| `python` 、 `php` 、 `javasrcipt` | `C语言` 、 `java` 、 `go` |",ct=`\r
\r
## :one: 下载 VScode (VSC)\r
\r
- 代码编辑器，用来编写代码的\r
...
\r
![img](/image/202402141345.png)`,zt="```javascript\r\nconst useEffect(()=>{},[])\r\n```",xt=`## 安装\r
\r
::: code-group\r
\r
\`\`\`shell\r
...
> \r
\r
![img](/image/202402141811.png)`,qt=`# SCSS\r
\r
👇 **重要说明与提示**\r
\r
...
\`\`\`\r
\r
:::`,Vt="",Xt='## 数据库管理工具\r\n\r\nheidisql [`👉 enter`](https://www.heidisql.com/download.php?download=portable-64){target="_blank"}  ',Qt="",Rt=`\r
## 介绍\r
\r
...
\r
\`\`\``,Zt=`[] 001  \r
[] 002  `,$t='官网\r\n[`👉 enter`](https://uniapp.dcloud.net.cn/){target="_blank"}',rs=`## 1. 编辑器下载\r
\r
...
│  ○ Custom Theme\r
└\r
\`\`\``,as="",ds="",ls=`::: danger <Badge type='danger'>注意</Badge>\r
\r
...
\r
\r
`,ks="- 虽说 `vitepress` 强调使用的是 `markdown` 语法  \r\n- 但是，但是不要忘记，**markdown**文件中是可以使用 **html** 语法的  \r\n- 当然，必要时，也可以用 **vue** 语法， ",zs=`## 重要性\r
\r
<br>\r
\r
...
\r
\`\`\``,Us="https://www.bilibili.com/video/BV1YW4y1F7uJ/?spm_id_from=333.1007.tianma.1-1-1.click",Vs=`::: danger  <Badge type='danger'>易错警告</Badge>\r
\r
...
VS Marketplace 链接: https://marketplace.visualstudio.com/items?itemName=vscode-icons-team.vscode-icons`,so="",oo=`# cssrem\r
\r
\r
\r
## 插件信息\r
...
\r
:::\r
`,io=`# Markdown Preview Enhanced\r
\r
## 插件信息\r
::: info  <Badge type='info'>基本信息</Badge>\r
\r
...
版本: 12.7.0\r
发布者: VSCode Icons Team\r
VS Marketplace 链接: https://marketplace.visualstudio.com/items?itemName=vscode-icons-team.vscode-icons`,lo=`### VSCode markdown 文件中无法使用用户代码片段 snippet 问题\r
\r
#### 方法一：  \r
\r
...
\r
\`C:\\Users\\long\\AppData\\Roaming\\Code\\User\\snippets\``,po="",mo=`---\r
aside: false\r
---\r
# Vue\r
\r
...
\r
\r
## 项目`,co=`::: danger  <Badge type='info'>警示</Badge>\r
请先安装node！！！\r
...
\`\`\`shell\r
pnpm i screenfull\r
\`\`\``,_o="单词的字母需要大写",bo="```js\r\nimport MyComponent from './App.vue'\r\n```",yo=`> 组件文件中 \`components/index.ts\`\r
\r
\`\`\`ts\r
...
\`\`\``,Oo="",Co=`> 在src 下新建router文件夹，并创建router/index.js文件\r
\`\`\`javascript\r
// 导入\r
...
最大的建站的程序，\r
\r
`,Ho=Object.assign({"../notes/boke_docs_developer/00 开发待解决问题.md":v,"../notes/boke_docs_developer/01 项目下载.md":_,"../notes/boke_docs_developer/02 目录解读.md":b,"../notes/boke_docs_developer/03 功能实现.md":y,"../notes/boke_docs_developer/config.md":f,"../notes/boke_docs_user/01 环境搭建.md":w,"../notes/boke_docs_user/02 配置信息.md":j,"../notes/boke_docs_user/03 MD语法扩展.md":k,"../notes/boke_docs_user/04 front-matter配置.md":z,"../notes/boke_docs_user/09 其他.md":x,"../notes/boke_docs_user/config.md":B,"../notes/build-site/00 简述.md":q,"../notes/build-site/01 基础知识/01 避坑指引.md":S,"../notes/build-site/01 基础知识/02 建站途径.md":T,"../notes/build-site/02 网站内容搭建/00 简述.md":E,"../notes/build-site/02 网站内容搭建/01 hexo.md":P,"../notes/build-site/02 网站内容搭建/02 vitepress.md":O,"../notes/build-site/02 网站内容搭建/03 其他.md":C,"../notes/build-site/03 网站部署/00 简述.md":D,"../notes/build-site/03 网站部署/01 服务器购买.md":F,"../notes/build-site/03 网站部署/02 后台搭建知识.md":I,"../notes/build-site/03 网站部署/03 nginx部署.md":A,"../notes/build-site/04 域名注册/00 简述.md":M,"../notes/build-site/04 域名注册/01 域名购买.md":G,"../notes/build-site/05 网站运维/01 服务器到期的处理.md":N,"../notes/build-site/config.md":L,"../notes/c-sharp/00 简述.md":J,"../notes/c-sharp/01 环境配置/01 使用VS2022.md":U,"../notes/c-sharp/01 环境配置/02 使用VScode.md":V,"../notes/c-sharp/02 基础知识/01 文件结构.md":X,"../notes/c-sharp/02 基础知识/02 基本语法.md":Q,"../notes/cocos-creator/00 简述.md":R,"../notes/cocos-creator/01 环境配置/01 下载编辑器.md":W,"../notes/cocos-creator/01 环境配置/02 界面说明.md":H,"../notes/component-library/00 简述.md":Y,"../notes/component-library/01 Element-plus/01 导入.md":K,"../notes/computer/01 硬件知识/00 前言.md":Z,"../notes/computer/02 系统相关/01 镜像下载.md":$,"../notes/computer/02 系统相关/02 系统重装.md":rr,"../notes/computer/03 扩展知识/02 虚拟机/02 虚拟机的创建/03 安装系统/01 win11演示.md":nr,"../notes/computer/03 扩展知识/02 虚拟机/03 常见使用/01 宿主机与虚拟机的交互.md":er,"../notes/computer/config.md":tr,"../notes/docker/00 简述.md":sr,"../notes/docker/01 环境配置/01 Linux安装docker.md":or,"../notes/docker/01 环境配置/02 windows安装docker.md":ir,"../notes/docker/02 基础知识/01 安装.md":ar,"../notes/docker/02 基础知识/02 基础指令.md":dr,"../notes/docker/02 基础知识/03 镜像操作.md":lr,"../notes/docker/02 基础知识/04 容器操作.md":gr,"../notes/docker/02 基础知识/05 数据卷操作.md":pr,"../notes/docker/02 基础知识/06 自定义镜像.md":mr,"../notes/docker/02 基础知识/07 网络.md":cr,"../notes/electron/00 简述.md":ur,"../notes/electron/01 前置准备.md":hr,"../notes/electron/02 项目创建/01 安装与初始化.md":vr,"../notes/electron/03 调试工作/01 调试工具.md":_r,"../notes/electron/04 窗口/01 创建窗口.md":br,"../notes/electron/05 主进程/01 app.md":yr,"../notes/electron/06 菜单/01 顶部菜单栏.md":fr,"../notes/electron/07 托盘/01 简述.md":wr,"../notes/express/00 简述.md":jr,"../notes/express/01 导入与使用.md":kr,"../notes/express/04 数据库/01 sqlite3.md":zr,"../notes/express/04 数据库/02 mysql.md":xr,"../notes/express/04 数据库/03 sqlite3-ORM.md":Br,"../notes/express/08 示例项目/00 目录结构.md":qr,"../notes/express/08 示例项目/01 app.js.md":Sr,"../notes/express/08 示例项目/02 db/01 blog.sqlite3文件.md":Tr,"../notes/express/08 示例项目/02 db/02 DbUtils.js.md":Er,"../notes/express/08 示例项目/03 package-lock.json.md":Pr,"../notes/express/08 示例项目/04 package.json.md":Or,"../notes/express/08 示例项目/06 routers/01 AdminRouter.js.md":Cr,"../notes/express/08 示例项目/06 routers/02 BlogRouter.js.md":Dr,"../notes/express/08 示例项目/06 routers/03 CategoryRouter.js.md":Fr,"../notes/express/08 示例项目/06 routers/04 TestRouter.js.md":Ir,"../notes/express/08 示例项目/06 routers/05 UploadRouter.js.md":Ar,"../notes/express/08 示例项目/07 utils/01 SnowFlake.js.md":Mr,"../notes/express/09 数据库使用.md":Gr,"../notes/game/00 简述.md":Nr,"../notes/game/01 游戏常识/01 steam基本知识.md":Lr,"../notes/game/01 游戏常识/01 平台相关.md":Jr,"../notes/game/01 游戏常识/02 MOD与修改器.md":Ur,"../notes/game/01 游戏常识/03 MOD与创意工坊.md":Vr,"../notes/game/01 游戏指南/01 戴森球.md":Xr,"../notes/game/01 游戏指南/02 中土世界：暗影摩多.md":Qr,"../notes/game/01 游戏指南/03 一起玩农场.md":Rr,"../notes/game/01 游戏指南/04 无人深空.md":Wr,"../notes/game/01 游戏指南/05 幻兽帕鲁.md":Hr,"../notes/game/01 游戏指南/06 波西亚时光.md":Yr,"../notes/game/01 游戏指南/07 星露谷.md":Kr,"../notes/game/01 游戏指南/08 生化危机.md":Zr,"../notes/game/02 手柄指南.md":$r,"../notes/game/03 游戏合集/01 低配机可以的玩的游戏.md":rn,"../notes/github/00 简述.md":nn,"../notes/github/01 前置基础/01 Git下载与安装.md":en,"../notes/github/01 前置基础/02 GIt指令.md":tn,"../notes/github/02 使用知识/01 账户设置.md":sn,"../notes/github/02 使用知识/02 仓库设置与操作.md":on,"../notes/github/02 使用知识/03 软件安装包区分.md":an,"../notes/github/03 .gitignore设置.md":dn,"../notes/github/04 主页美化.md":ln,"../notes/github/99 使用问题/01 software报错.md":gn,"../notes/github/99 使用问题/02 action报错.md":pn,"../notes/html/00 简述.md":mn,"../notes/html/01 环境配置/01 浏览器选择.md":cn,"../notes/html/01 环境配置/02 编辑器选择.md":un,"../notes/html/03 标签与功能/01 布局标签.md":hn,"../notes/html/03 标签与功能/02 图片.md":vn,"../notes/html/03 标签与功能/03 视频.md":_n,"../notes/html/03 标签与功能/04 字体与字体图标.md":bn,"../notes/javascript/00 简述.md":yn,"../notes/javascript/01 基本知识/01 书写位置、注释与结束符.md":fn,"../notes/javascript/01 基本知识/03 基本语法.md":wn,"../notes/javascript/01 基本知识/04 变量与常量.md":jn,"../notes/javascript/01 基本知识/05 数据类型.md":kn,"../notes/javascript/01 基本知识/06 运算符号.md":zn,"../notes/javascript/01 基本知识/07 表达式与语句.md":xn,"../notes/javascript/01 基本知识/08 调试与异常处理.md":Bn,"../notes/javascript/01 基本知识/09 JS的执行机制.md":qn,"../notes/javascript/01 基本知识/10 类型转换[进阶].md":Sn,"../notes/javascript/01 基本知识/12 防抖.md":Tn,"../notes/javascript/02 字符串/01 方法.md":En,"../notes/javascript/02 字符串/01 查询字符串.md":Pn,"../notes/javascript/02 字符串/02 截取字符串.md":On,"../notes/javascript/03 数组操作/01 数组基本操作.md":Cn,"../notes/javascript/03 数组操作/02 解构赋值.md":Dn,"../notes/javascript/03 数组操作/05 数组去重.md":Fn,"../notes/javascript/03 数组操作/06 map.md":In,"../notes/javascript/03 数组操作/07 join.md":An,"../notes/javascript/03 数组操作/09 forEach.md":Mn,"../notes/javascript/03 数组操作/10 filter.md":Gn,"../notes/javascript/03 数组操作/11 reduce.md":Nn,"../notes/javascript/03 数组操作/12 数组的其他方法.md":Ln,"../notes/javascript/03 数组操作/13 合并数组.md":Jn,"../notes/javascript/03 数组操作/14 数组去重.md":Un,"../notes/javascript/04 对象/01 对象.md":Vn,"../notes/javascript/04 对象/02 增删改查.md":Xn,"../notes/javascript/04 对象/03 遍历对象.md":Qn,"../notes/javascript/04 对象/04 math对象.md":Rn,"../notes/javascript/04 对象/05 对象解构赋值.md":Wn,"../notes/javascript/04 对象/06 内置的函数.md":Hn,"../notes/javascript/04 对象/07 深浅拷贝.md":Yn,"../notes/javascript/05 函数/01 声明.md":Kn,"../notes/javascript/05 函数/02 参数.md":Zn,"../notes/javascript/05 函数/03 返回值.md":$n,"../notes/javascript/05 函数/04 作用域.md":re,"../notes/javascript/05 函数/05 匿名函数.md":ne,"../notes/javascript/05 函数/06 回调函数.md":ee,"../notes/javascript/05 函数/07 环境对象.md":te,"../notes/javascript/05 函数/08 函数提升.md":se,"../notes/javascript/05 函数/09 箭头函数.md":oe,"../notes/javascript/05 函数/10 构造函数.md":ie,"../notes/javascript/05 函数/11 this.md":ae,"../notes/javascript/06 DOM/01 简述.md":de,"../notes/javascript/06 DOM/02 获取DOM元素.md":le,"../notes/javascript/06 DOM/03 修改DOM元素.md":ge,"../notes/javascript/06 DOM/04 定时器.md":pe,"../notes/javascript/06 DOM/05 标签的自定义属性.md":me,"../notes/javascript/06 DOM/06 事件监听（绑定).md":ce,"../notes/javascript/06 DOM/07 事件流.md":ue,"../notes/javascript/06 DOM/08 事件委托.md":he,"../notes/javascript/06 DOM/09 阻止默认行为.md":ve,"../notes/javascript/06 DOM/10 页面加载事件.md":_e,"../notes/javascript/06 DOM/11 日期对象.md":be,"../notes/javascript/06 DOM/12 节点操作.md":ye,"../notes/javascript/06 DOM/13 触屏事件.md":fe,"../notes/javascript/07 BOM/01 window对象.md":we,"../notes/javascript/07 BOM/02 定时函数.md":je,"../notes/javascript/07 BOM/03 事件循环.md":ke,"../notes/javascript/07 BOM/04 location.md":ze,"../notes/javascript/07 BOM/05 localStorage.md":xe,"../notes/javascript/08 正则表达式/01 定义正则表达式.md":Be,"../notes/javascript/08 正则表达式/02 元字符.md":qe,"../notes/javascript/80 事件/01 点击事件.md":Se,"../notes/javascript/80 事件/02 鼠标事件.md":Te,"../notes/javascript/85 JS库/01 UUID.md":Ee,"../notes/javascript/85 JS库/02 axios.md":Pe,"../notes/javascript/config.md":Oe,"../notes/mysql/00 简述.md":Ce,"../notes/nestjs/00 简述.md":De,"../notes/nestjs/02 基本/01 初始化项目.md":Fe,"../notes/network-request/00 简述.md":Ie,"../notes/network-request/01 axios/00 简述.md":Ae,"../notes/network-request/02 mo/01 mo.md":Me,"../notes/nginx/00 简述.md":Ge,"../notes/nginx/01 下载与安装.md":Ne,"../notes/nginx/02 命令与配置.md":Le,"../notes/nodejs/00 简述.md":Je,"../notes/nodejs/01 基础知识/00 下载与安装.md":Ue,"../notes/nodejs/01 基础知识/01 命令行基础.md":Ve,"../notes/nodejs/01 基础知识/02 基本规则.md":Xe,"../notes/nodejs/01 基础知识/03 buffer.md":Qe,"../notes/nodejs/01 基础知识/04 版本管理.md":Re,"../notes/nodejs/02 包管理工具/01 基本操作.md":We,"../notes/nodejs/02 包管理工具/02 发布与管理.md":He,"../notes/nodejs/03 模块知识/00 模块使用与导入.md":Ye,"../notes/nodejs/03 模块知识/01 文件模块-file/01 文件写入.md":Ke,"../notes/nodejs/03 模块知识/01 文件模块-file/03 文件读取.md":Ze,"../notes/nodejs/03 模块知识/01 文件模块-file/04 文件重命名与移动.md":$e,"../notes/nodejs/03 模块知识/01 文件模块-file/05 文件删除.md":rt,"../notes/nodejs/03 模块知识/01 文件模块-file/06 文件夹操作.md":nt,"../notes/nodejs/03 模块知识/01 文件模块-file/07 文件信息查询.md":et,"../notes/nodejs/03 模块知识/02 路径模块-path/01 path.md":tt,"../notes/nodejs/03 模块知识/03 网络模块-http/01 HTTP协议.md":st,"../notes/nodejs/03 模块知识/03 网络模块-http/02 http模块.md":ot,"../notes/nodejs/03 模块知识/03 网络模块-http/03 http练习.md":it,"../notes/nodejs/03 模块知识/04 模块化开发/01 模块化.md":at,"../notes/nodejs/03 模块知识/05 模板引擎/ejs.md":dt,"../notes/nodejs/05 小技巧与功能实现/01 node注册成win服务.md":lt,"../notes/nodejs/09 es语法差异/01 差异.md":gt,"../notes/nodejs/99 报错合集.md":pt,"../notes/python/00 简述.md":mt,"../notes/python/01 环境配置/01 编辑器环境.md":ct,"../notes/python/01 环境配置/02 python环境.md":ut,"../notes/python/02 基础知识/01 注释.md":ht,"../notes/python/02 基础知识/02 字面量与常量.md":vt,"../notes/python/02 基础知识/03 变量.md":_t,"../notes/react/00 简述.md":bt,"../notes/react/01 前置准备/01 知识储备.md":yt,"../notes/react/01 前置准备/02 开发环境.md":ft,"../notes/react/04 数据绑定/02 input.md":wt,"../notes/react/04 数据绑定/03 dom绑定.md":jt,"../notes/react/05 组件通信/01 父子通信.md":kt,"../notes/react/06 useEffect/01 01.md":zt,"../notes/react/08 redux/01 基本使用.md":xt,"../notes/react/08 redux/02 React中使用.md":Bt,"../notes/scss/00 简述.md":qt,"../notes/scss/01 基础知识/00 定义变量.md":St,"../notes/scss/01 基础知识/01 文件引用.md":Tt,"../notes/scss/01 基础知识/03 全局使用.md":Et,"../notes/scss/02 字体与文本处理/01 改变字体.md":Pt,"../notes/scss/02 字体与文本处理/02 引用字体.md":Ot,"../notes/scss/02 字体与文本处理/03 字体资源.md":Ct,"../notes/scss/02 字体与文本处理/04 渐变字体.md":Dt,"../notes/scss/02 字体与文本处理/05 下划线.md":Ft,"../notes/scss/04 界面切换/01 简述.md":It,"../notes/scss/09 常见应用/01 滚动条美化.md":At,"../notes/scss/09 常见应用/02 样式清楚.md":Mt,"../notes/scss/09 常见应用/03 移动端适配.md":Gt,"../notes/scss/09 常见应用/04 界面阴影.md":Nt,"../notes/scss/09 常见应用/05 网格背景.md":Lt,"../notes/scss/09 常见应用/06 彩虹背景.md":Jt,"../notes/scss/09 常见应用/07 毛玻璃效果.md":Ut,"../notes/sqlite/00 简述.md":Vt,"../notes/sqlite/01 下载与使用.md":Xt,"../notes/teleplay/02 影视评价.md":Qt,"../notes/typescript/00 简述.md":Rt,"../notes/typescript/01 基础与语法/01 安装与使用.md":Wt,"../notes/typescript/01 基础与语法/02 初始化项目.md":Ht,"../notes/typescript/01 基础与语法/03 类型声明.md":Yt,"../notes/typescript/02 类型/01 原始类型.md":Kt,"../notes/typescript/02 类型/02 元组.md":Zt,"../notes/uniapp/00 简述.md":$t,"../notes/uniapp/01 基本配置/01 编辑器环境.md":rs,"../notes/uniapp/01 基本配置/02 项目创建.md":ns,"../notes/uniapp/02 模块设计/03 底部导航.md":es,"../notes/uniapp/02 模块设计/04 启动界面.md":ts,"../notes/vitepress/00 简述.md":ss,"../notes/vitepress/01 项目创建/00 环境配置.md":os,"../notes/vitepress/01 项目创建/01 安装与初始化.md":is,"../notes/vitepress/01 项目创建/02 项目目录解读.md":as,"../notes/vitepress/01 项目创建/03 本地运行与调试.md":ds,"../notes/vitepress/01 项目创建/04 个人特色配置.md":ls,"../notes/vitepress/02 站点配置/01 站点元数据.md":gs,"../notes/vitepress/03 网站编辑/00 简述.md":ps,"../notes/vitepress/03 网站编辑/01 标题：SiteTitle.md":ms,"../notes/vitepress/03 网站编辑/02 标志：Logo.md":cs,"../notes/vitepress/03 网站编辑/03 导航菜单：Nav.md":us,"../notes/vitepress/03 网站编辑/04 侧边栏：sidebar.md":hs,"../notes/vitepress/03 网站编辑/05 页面大纲：outline.md":vs,"../notes/vitepress/03 网站编辑/06 大纲容器：aside.md":_s,"../notes/vitepress/03 网站编辑/07 页脚：footer.md":bs,"../notes/vitepress/03 网站编辑/08 搜索：search.md":ys,"../notes/vitepress/03 网站编辑/09 徽章：badge.md":fs,"../notes/vitepress/03 网站编辑/10 社交链接.md":ws,"../notes/vitepress/03 网站编辑/99 frontmatter.md":js,"../notes/vitepress/04 文档编辑/00 简述.md":ks,"../notes/vitepress/04 文档编辑/01 文件路径.md":zs,"../notes/vitepress/04 文档编辑/02 标题.md":xs,"../notes/vitepress/04 文档编辑/03 文字强调.md":Bs,"../notes/vitepress/04 文档编辑/04 下划线.md":qs,"../notes/vitepress/04 文档编辑/05 字体美化.md":Ss,"../notes/vitepress/04 文档编辑/06 超链接.md":Ts,"../notes/vitepress/04 文档编辑/07 列表.md":Es,"../notes/vitepress/04 文档编辑/08 表格.md":Ps,"../notes/vitepress/04 文档编辑/09 图片.md":Os,"../notes/vitepress/04 文档编辑/10 emoji 表情.md":Cs,"../notes/vitepress/04 文档编辑/11 自定义容器.md":Ds,"../notes/vitepress/04 文档编辑/12 代码块.md":Fs,"../notes/vitepress/04 文档编辑/13 代码组.md":Is,"../notes/vitepress/04 文档编辑/14 脚注.md":As,"../notes/vitepress/04 文档编辑/15 思维导图.md":Ms,"../notes/vitepress/04 文档编辑/16 分割线.md":Gs,"../notes/vitepress/04 文档编辑/45 嵌入文档.md":Ns,"../notes/vitepress/04 文档编辑/99 视频.md":Ls,"../notes/vitepress/05 使用vue/01 组件的全局注册.md":Js,"../notes/vitepress/06 项目部署/01 Github部署/01 前置步骤.md":Us,"../notes/vitepress/06 项目部署/01 Github部署/02 构建配置.md":Vs,"../notes/vitepress/06 项目部署/01 Github部署/03 自动化部署.md":Xs,"../notes/vitepress/06 项目部署/01 Github部署/04 常规部署.md":Qs,"../notes/vitepress/06 项目部署/02 服务器部署/01 node后台.md":Rs,"../notes/vitepress/07 插件生态.md":Ws,"../notes/vitepress/10 问题与报错.md":Hs,"../notes/vitepress/config.md":Ys,"../notes/vscode/00 简述.md":Ks,"../notes/vscode/01 下载与安装/01 下载.md":Zs,"../notes/vscode/01 下载与安装/02 汉化.md":$s,"../notes/vscode/02 基本使用/01 常用设置.md":ro,"../notes/vscode/02 基本使用/02 快捷键.md":no,"../notes/vscode/02 基本使用/03 用户代码片段.md":eo,"../notes/vscode/03 插件/00 插件安装演示.md":to,"../notes/vscode/03 插件/01 通用型插件/01 ProjectManager.md":so,"../notes/vscode/03 插件/01 通用型插件/02 cssrem.md":oo,"../notes/vscode/03 插件/02 markdown相关/01 MarkdownPreviewEnhanced.md":io,"../notes/vscode/03 插件/99 自用插件清单.md":ao,"../notes/vscode/04 相关问题/00 问题.md":lo,"../notes/vscode/05 代码片段/00 创建.md":go,"../notes/vscode/05 代码片段/01 markdown代码提示.md":po,"../notes/vue/00 简述.md":mo,"../notes/vue/01 创建项目/01 vite构建.md":co,"../notes/vue/01 创建项目/02 目录解读.md":uo,"../notes/vue/01 创建项目/03 原生html中使用.md":ho,"../notes/vue/01 创建项目/04 可选内容.md":vo,"../notes/vue/04 组件基础/01 命名规范.md":_o,"../notes/vue/04 组件基础/01 导入组件.md":bo,"../notes/vue/04 组件基础/03 组件的全局注册.md":yo,"../notes/vue/05 响应式数据/01 ref、reactive.md":fo,"../notes/vue/05 响应式数据/02 自定义ref.md":wo,"../notes/vue/05 响应式数据/04 toRef.md":jo,"../notes/vue/05 响应式数据/05 双向绑定.md":ko,"../notes/vue/07 侦听器/01 watch.md":zo,"../notes/vue/07 侦听器/02 watchEffect.md":xo,"../notes/vue/09 生命周期/01 简述.md":Bo,"../notes/vue/10 组件通信/01 简述.md":qo,"../notes/vue/10 组件通信/02 父子通信.md":So,"../notes/vue/10 组件通信/03 祖孙通信.md":To,"../notes/vue/10 组件通信/04 兄弟通信.md":Eo,"../notes/vue/10 组件通信/05 全局总线.md":Po,"../notes/vue/80 路由/01 简述.md":Oo,"../notes/vue/80 路由/02 创建路由.md":Co,"../notes/vue/80 路由/03 router-view.md":Do,"../notes/vue/80 路由/04 路由模式.md":Fo,"../notes/vue/80 路由/05 router-Link.md":Io,"../notes/vue/80 路由/06 嵌套路由.md":Ao,"../notes/vue/80 路由/07 编程式路由跳转.md":Mo,"../notes/vue/80 路由/08 重定向.md":Go,"../notes/vue/90 pinia/01 创建.md":No,"../notes/vue/90 pinia/02 数据存储.md":Lo,"../notes/vue/91 UI组件库/01 element_UI.md":Jo,"../notes/vue/97 vue2遗留问题/01 vue2与vue3不同点.md":Uo,"../notes/vue/98 项目练习/01 mo_browser.md":Vo,"../notes/vue/99 报错合集/01 部署问题.md":Xo,"../notes/vue/99 报错合集/04 router.md":Qo,"../notes/vue/vue.md":Ro,"../notes/wordpress/00 简述.md":Wo}),Yo={cover:"momo",desc:"暂无描述"};function Ko(){const n={};return Object.entries(Ho).forEach(([s,i])=>{const o=s.replace(/^.*notes\//,"").split("/"),r=o[0],e=o.slice(1).join("/"),{attributes:t,body:a}=c(i),{render:p}=u(),{html:d}=p(a);if(n[r]||(n[r]={id:r,path:"/notes/"+r,categories:[r],meta:{...Yo},files:[]}),e.toLowerCase()==="config.md")n[r].meta={...n[r].meta,...t},n[r].content=a,n[r].html=d;else{const m=e.replace(/\.md$/,""),l=h(e);n[r].files.push({id:l,meta:{...t,title:t.title||l},content:a,html:d,path:`/notes/${r}/${m}`,subPath:e.replace(/\.md$/,"")})}}),Object.values(n)}function $o(n){return Ko().flatMap(s=>s.files).find(s=>s.path===n)}function ri(n){const i=new DOMParser().parseFromString(n,"text/html");return Array.from(i.querySelectorAll("h2, h3, h4, h5, h6")).map(o=>{const r=Number(o.tagName.substring(1)),e=o.textContent?.trim()??"";let t=o.id?.trim()??"";return t||(t=e.toLowerCase().replace(/\s+/g,"-").replace(/[^\w\-]/g,"").replace(/\-+/g,"-").replace(/^\-+|\-+$/g,"")),{level:r,title:e,slug:t}})}export{$o as a,ri as b,Ko as g};
